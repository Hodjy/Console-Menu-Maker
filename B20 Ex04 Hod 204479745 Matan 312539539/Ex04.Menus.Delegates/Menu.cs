...
", Name);
        ...
        public void MakeActivator(string i_ActivatorName, Activator i_MethodToActivate)
        {
            MethodActivator newActivator = new MethodActivator(i_ActivatorName);

            newActivator.MethodClicked += i_MethodToActivate;
